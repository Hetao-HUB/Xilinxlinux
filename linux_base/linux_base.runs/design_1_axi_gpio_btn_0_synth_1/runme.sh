...
HD_PWD='F:/ax7010/2017/course_s1/11_linux_base/linux_base.runs/design_1_axi_gpio_btn_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_btn_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_btn_0.tcl
